		...
		<div class="post-info"> 
			...
			<?php else : ?>
				<div class="entry-summary">
					<?php the_excerpt(); ?>
					<a class="readmore button" href="<?php the_permalink(); ?>"><?php if(isset($naturecircle_opt['readmore_text']) && $naturecircle_opt['readmore_text']!=''){ echo esc_html($naturecircle_opt['readmore_text']); } else { echo esc_html_e('Read more', 'naturecircle');}  ?></a>  
				</div>
			<?php endif; ?> 
			<?php if ( is_single() ) : ?>
