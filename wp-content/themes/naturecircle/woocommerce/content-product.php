...
$naturecircle_productsfound = Naturecircle_Class::naturecircle_shortcode_products_count();
...
<?php if ( ( ( 0 == $woocommerce_loop['loop'] % 2 || $naturecircle_productsfound == $woocommerce_loop['loop'] ) && $woocommerce_loop['columns'] == 2 )  ) { /* for odd case: $naturecircle_productsfound == $woocommerce_loop['loop'] */
	echo '</div>';
} ?>
<?php if ( ( ( 0 == $woocommerce_loop['loop'] % 3 || $naturecircle_productsfound == $woocommerce_loop['loop'] ) && $woocommerce_loop['columns'] == 3 )  ) { /* for odd case: $naturecircle_productsfound == $woocommerce_loop['loop'] */
	echo '</div>';
} ?>
<?php if ( ( ( 0 == $woocommerce_loop['loop'] % 4 || $naturecircle_productsfound == $woocommerce_loop['loop'] ) && $woocommerce_loop['columns'] == 4 )  ) { /* for odd case: $naturecircle_productsfound == $woocommerce_loop['loop'] */
	echo '</div>';
} ?>