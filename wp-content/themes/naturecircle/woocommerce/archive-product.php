								...
								<?php if ( woocommerce_products_will_display() ) { ?>
									<div class="toolbar">
										<div class="toolbar-inner">  
											<div class="view-mode">
												<label><?php esc_html_e('View on', 'naturecircle');?></label>
												<a href="#" class="grid <?php if($naturecircle_viewmode=='grid-view'){ echo ' active';} ?>" title="<?php echo esc_attr__( 'Grid', 'naturecircle' ); ?>"> <?php echo esc_attr__( 'Grid', 'naturecircle' ); ?></a>
												<a href="#" class="list <?php if($naturecircle_viewmode=='list-view'){ echo ' active';} ?>" title="<?php echo esc_attr__( 'List', 'naturecircle' ); ?>"> <?php echo esc_attr__( 'List', 'naturecircle' ); ?></a>
											</div>
											<?php
												/**
